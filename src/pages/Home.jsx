  ...
  return (
    <div className="max-h-full flex w-[100vw] overflow-hidden h-[100vh]">
      <div className="w-[38%] relative h-full  bg-transparent-bg">
        ...
        <img
          className="w-[600px] h-[800px] absolute top-0 z-0 opacity-5"
          src={focatia}
          alt=""
        />
      </div>
      ...
      <div className="bg-w-bg relative w-full h-full">
        <div>
          <img
            className="w-[435px] h-[240px] mx-[125px] my-[40px] translate-x-[80px]"
            src={banner2}
            alt="banner2"
          />
          <img
            className="w-[430px] h-[210px] translate-x-[40px] -translate-y-[90px]"
            src={banner1}
            alt="banner1"
          />
          <img
            className="w-[430px] h-[210px] mx-[200px] my-[0px] translate-x-[100px] -translate-y-[280px]"
            src={banner3}
            alt="banner3"
          />
        </div>
